...
const sesClient = new client_ses_1.SESClient({ region: SES_REGION });
const snsClient = new client_sns_1.SNSClient({ region: SNS_REGION });
/**
 * Validate form data
...
//# sourceMappingURL=contactLambda.js.map