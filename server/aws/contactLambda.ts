 ...
 */
const sendEmailNotification = async (formData: ContactFormData): Promise<string> => {
 ...
 */
const sendSmsNotification = async (formData: ContactFormData): Promise<string> => {
...
export const handler = async (event: LambdaEvent): Promise<LambdaResponse> => {
  ...
  try {
    ...
    const formData: ContactFormData = typeof event.body === 'string' 
      ? JSON.parse(event.body) 
      : event.body as ContactFormData;
